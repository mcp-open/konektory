...
from connector_fio.service import ORIGIN, SLUG, VERSION
...
def test_manifest_matches_runtime() -> None:
    ...
    assert ORIGIN == "https://fioapi.fio.cz/v1/rest"
    ...
    assert [item["key"] for item in manifest["credentials"]] == ["token", "pii_key"]
